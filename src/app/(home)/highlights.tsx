    ...
    <section className="flex flex-col gap-6 px-4 py-8 md:px-8 xl:px-16 2xl:px-40">
      ...
      <div className="flex gap-2 overflow-scroll pb-4 md:grid md:grid-cols-2 md:gap-6 md:overflow-hidden">
        {data.map((item) => (
          ...
          >
            <div className="group relative flex h-44 w-[96%] flex-none cursor-pointer justify-end overflow-hidden rounded-lg border border-slate-200 shadow-sm md:h-52 md:w-full xl:h-64">
